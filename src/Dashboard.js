...
import driver from './driver.gif';
import booking from './notebook.gif';
    ...
    <>
      <body class="flex bg-gray-100 min-h-screen">
        <aside class="hidden sm:flex sm:flex-col">
          <a href="#" class="inline-flex items-center justify-center h-20 w-20 bg-slate-950 hover:bg-slate-950 focus:bg-slate-950">
          ...
          <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
            <nav class="flex flex-col mx-4 my-6 space-y-4">
              ...
              <a href="#" class="inline-flex items-center justify-center py-3 text-yellow-500 bg-white rounded-lg">
            ...
            <div class="flex flex-shrink-0 items-center ml-auto">
              <button class="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
                ...
                <div class="hidden md:flex md:flex-col md:items-end md:leading-tight">
                  <span class="font-semibold">ABCDEF</span>
                  <span class="text-sm text-gray-600">Admin</span>
                </div>
                <span class="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                  <img src="https://www.iconpacks.net/icons/2/free-user-icon-3296-thumb.png" alt="user profile photo" class="h-full w-full object-cover" />
          ...
          <main class="p-6 sm:p-10 space-y-6">
            <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
              ...
              <div class="flex flex-wrap items-start justify-end -mb-3">
                <button class="inline-flex px-5 py-3 text-yellow-500 hover:text-yellow-500 focus:text-yellow-500 hover:bg-yellow-100 focus:bg-purple-100 border border-yellow-500 rounded-md mb-3">
                  <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                  </svg>
                  Manage dashboard
                </button>
                <button class="inline-flex px-5 py-3 text-white bg-yellow-500 hover bg-yellow-500 focus:bg-yellow-500 rounded-md ml-6 mb-3">
            ...
            <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div class="flex items-center p-8 bg-white shadow rounded-lg">
                <div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-yellow-500 bg-yellow-100 rounded-full mr-6">

                  <img src={taxi} />
                </div>
                <div>
                  <span class="block text-2xl font-bold">450</span>
                  <span class="block text-gray-500">Trips</span>
                </div>
              </div>
              <div class="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                ...
                <div>
                  <span class="block text-2xl font-bold">260</span>
                  <span class="block text-gray-500">Passengers</span>
                </div>
              </div>
              <div class="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6" />
                ...
                <div>
                  <span class="inline-block text-2xl font-bold">45</span>
                  {/* <span class="inline-block text-xl text-gray-500 font-semibold">(1</span> */}
                  <span class="block text-gray-500">Drivers</span>
                </div>
              </div>
              <div class="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                ...
                <div>
                  <span class="block text-2xl font-bold">80</span>
            ...
            <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div class="px-6 py-5 font-semibold border-b border-gray-100">Taxi and Drivers Location</div>
                <div class="p-4 flex-grow">
                  <img src="https://www.medianama.com/wp-content/uploads/2018/06/Screenshot_20180619-112715.png.png" className="cabmap" />
                </div>
              </div>
              <div class="flex items-center p-8 bg-white shadow rounded-lg">
